    ...
    preloadSounds = async () => {
        ...
        try {
            if (notes[0] === 'c') {
                ...
                alert('Error: Audio for note at index 0 does not exist');
            }
            ...
            if (notes[1] === 'a') {
                ...
                alert('Error: Audio for note at index 1 does not exist');
            }
            ...
            if (notes[2] === 'c') {
                ...
                alert('Error: Audio for note at index 2 does not exist');
            }
            ...
            if (notes[3] === 'c') {
                ...
                alert('Error: Audio for note at index 3 does not exist');
            }
            ...
            if (notes[4] === 'a') {
                ...
                alert('Error: Audio for note at index 4 does not exist');
            }
            ...
            if (notes[5] === 'c') {
                ...
                alert('Error: Audio for note at index 5 does not exist');
            }

        } catch (err) {
            alert(`Error preloading audio: ${err.message}`);
        }
    }

    playTune = async () => {
        try {
            await this.tune0.replayAsync();
            await this.tune1.replayAsync();
            await this.tune2.replayAsync();
            await this.tune3.replayAsync();
            await this.tune4.replayAsync();
            await this.tune5.replayAsync();
        } catch (err) {
